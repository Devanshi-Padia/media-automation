...
from src.app.core.db.database import DATABASE_URL, AsyncSession, async_engine, local_session
...
async def create_first_user(session: AsyncSession) -> None:
    try:
        ...
        if user is None:
            ...
            logger.info(f"Admin user {username} password updated and email verified.")
